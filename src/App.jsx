            ...
            <main className="container mx-auto px-4 py-8 pt-32 min-h-[calc(100vh-128px)] relative z-10">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute -bottom-10 -right-10 w-60 h-60 rounded-full bg-pink-500/20 blur-3xl"
                    ></motion.div>
                    ...
                    >
                        <button 
                            ...
                            className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl text-white font-bold shadow-lg hover:shadow-purple-500/30 transition duration-300 transform hover:scale-105"
                        >
                            Explore Collection
                        </button>
                    </motion.div>
                ...
                >
                    ...
                    <div className="backdrop-blur-md bg-white/5 rounded-2xl p-8 border border-white/10 shadow-xl">
                        ...
                        <p className="text-4xl font-bold flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 text-pink-500">
                                    ...
                                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                                        ...
                                        <div className="relative w-full md:w-64">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/5 backdrop-blur-md border border-white/10 rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                            />
                                        </div>
                                    </div>
